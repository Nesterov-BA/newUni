...
class MyGLWidget : public QGLWidget{
    ...
    double(*d2f)(double, double, int); //2nd derivative
    ...
    double *Fy=nullptr;
    double *Fxy=nullptr;
    double *TF=nullptr; //matrix of interpolation coefficients
    double *Gamma=nullptr; //intermediate matrix
    double *intValues = nullptr;
    double *intX = nullptr;
    double *intY = nullptr;
    double *d2Fx = nullptr;
    double *d2Fy = nullptr;
